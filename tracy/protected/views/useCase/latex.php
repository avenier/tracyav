...
<h1>View Generated LaTeX for UseCases</h1>

<?php

$sourceArray = array();

function useCaseSort($a, $b) {
    return $a->public_id() == $b->public_id() ? 0 : ( $a->public_id() > $b->public_id() ) ? 1 : -1;
}
$list = usort(UseCase::model()->findAll(), 'useCaseSort');
