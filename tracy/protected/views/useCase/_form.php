...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">
        <?php echo $form->labelEx($model,'gparent'); ?>
        <?php $this->widget('zii.widgets.jui.CJuiAutoComplete',
                array(
		    'name' => 'gparent_autocomplete',
                    'model'=>$model,
                    'attribute'=>'gparent',
                    'sourceUrl'=>array('useCase/gparentcompletion'),
                    'options'=>array(
		      'minLength'=>'2',
		      'select'=>'js:function( event, ui ) {
			 $(this).val(ui.item.id);
        ...
        <?php echo $form->error($model,'gparent'); ?>
    </div>
    ...
    <div class="row">
        ...
        <?php echo $form->textField($model,'actors'); ?>
