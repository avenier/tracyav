...
class LatexTableCreator extends TableCreator
{
    ...
    function title($level,$text,$title=null)
    {
        ...
        switch ( $level )
        {
            ...
            case 4: return "\\subsubsubsection$title{{$text}}\n";
            case 5: return "\\paragraph$title{{$text}}\n";
            case 6: return "\\subparagraph$title{{$text}}\n";
            case 7: return "\\subsubparagraph$title{{$text}}\n";
            default: return "$text\n";
        }
    }
    function begin_list()
